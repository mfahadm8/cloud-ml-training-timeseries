...
import os
import sys
from utils.evalution_criteria import calculate_sharpe_ratio
...
def main(user_ml_script_s3_uri, user_ml_output_csv_s3_uri):
    ...
    if SHOULD_PERFORM_COMPLETE_TRAINING:
        ...
        # Step 1: Run the downloaded script
        update_script_with_template_functions(script_file,template_functions_mapping)
