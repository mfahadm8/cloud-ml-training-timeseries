...
class MlTrainingBatchJob(Construct):
    proc_name: str
    job_queue_name: str
    ...
    def __init__(
        ...
        if fargate_disabled:
            ...
            with open(from_here("assets", "user_data_xray.txt")) as f:
            ...
            if lustre_fs:
                ...
                if proc_name in ["xilinx", "nvidia"]:
                    with open(from_here("assets", "user_data_gpu.txt")) as f:
                ...
                with open(from_here("assets", "user_data_lustre.txt")) as f:
